...
import type { Faction } from "../lib/api.js";
...
export function registerFactionCommands(program: Command): void {
  ...
  faction
    ...
    .option("-d, --description <desc>", "Faction description")
  ...
  faction
    ...
    .option("-d, --description <desc>", "Update faction description (will wrap in <p> tags)")
    ...
    .action(async (id, jsonArg, options) => {
      try {
        ...
        if (options.file) {
          ...
          console.log("\nUsage:");
          console.log('  chiwar faction update <id> --name "New Name"');
          console.log('  chiwar faction update <id> --description "New description"');
          console.log('  chiwar faction update <id> --description-html "<p>HTML description</p>"');
          console.log("  chiwar faction update <id> --file update.json");
          process.exit(1);
        }
